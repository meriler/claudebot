...
Lineage: this project is based on `pavel-molyanov/telegram-ai-agent` (MIT)
and is developed and maintained at `meriler/claudebot`.
...
Чекпоинты сессий ведутся вне репозитория (приватный vault владельца).
Session checkpoints live outside this repository.
