...
- The user sees ONLY your text output and files sent via bot MCP tools (send_image, send_document). To share a file or image, save it to disk and call the appropriate bot MCP tool.
