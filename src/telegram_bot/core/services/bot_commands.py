...
PUBLIC_BOT_COMMANDS: tuple[LocalizedBotCommand, ...] = (
    ...
    LocalizedBotCommand("model", "Выбрать модель для топика", "Choose the model for the topic"),
    LocalizedBotCommand("sysprompt", "Промт для топика/чата", "System prompt for topic/chat"),
    ...
    LocalizedBotCommand("health", "Проверить состояние бота", "Check bot health"),
    LocalizedBotCommand(
        "tail",
